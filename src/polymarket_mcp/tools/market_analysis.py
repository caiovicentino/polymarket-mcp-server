...
async def _note_http_429(
    ...
    """Thin delegate to the shared 429 note helper (wiring T-0358).

    Name/signature preserved for the call sites (Gamma and market-data
    fetch sites); the Retry-After clamp lives in ``handle_429_error``.
    """
